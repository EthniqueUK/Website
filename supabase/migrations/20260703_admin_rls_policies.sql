...
-- Prerequisite: 20260703_admin_portal_schema.sql
-- Source: supabase/TableSchemas/20_admin_rls_policies.sql
-- =========================================
...
drop policy if exists "Super admins can read all staff profiles" on public.profiles;
...
drop policy if exists "Vendors can read their managers" on public.profiles;
...
drop policy if exists "Super admins can manage staff profiles" on public.profiles;
...
drop policy if exists "Vendors can manage their managers" on public.profiles;
...
drop policy if exists "Super admins can manage vendor onboarding invites" on public.vendor_onboarding_invites;
...
drop policy if exists "Super admins can manage vendor onboarding submissions" on public.vendor_onboarding_submissions;
...
drop policy if exists "Super admins can read vendor identity documents" on public.vendor_identity_documents;
...
drop policy if exists "Super admins can read all audit logs" on public.admin_audit_log;
...
drop policy if exists "Staff can read audit logs for their market" on public.admin_audit_log;
...
drop policy if exists "Staff can insert audit log entries" on public.admin_audit_log;
...
drop policy if exists "Public can read active markets" on public.markets;
...
drop policy if exists "Super admins can manage markets" on public.markets;
...
drop policy if exists "Vendor or above can manage categories" on public.categories;
...
drop policy if exists "Staff can read accessible products" on public.products;
...
drop policy if exists "Staff can insert accessible products" on public.products;
...
drop policy if exists "Staff can update accessible products" on public.products;
...
drop policy if exists "Vendor or above can delete accessible products" on public.products;
...
drop policy if exists "Staff can modify accessible product images" on public.product_images;
...
drop policy if exists "Staff can modify accessible product variants" on public.product_variants;
...
drop policy if exists "Public can read active product market data" on public.product_market_data;
...
drop policy if exists "Staff can read accessible product market data" on public.product_market_data;
...
drop policy if exists "Staff can insert accessible product market data" on public.product_market_data;
...
drop policy if exists "Staff can update accessible product market data" on public.product_market_data;
...
drop policy if exists "Vendor or above can delete accessible product market data" on public.product_market_data;
...
drop policy if exists "Vendor or above can manage orders" on public.orders;
...
drop policy if exists "Vendor or above can manage order items" on public.order_items;
...
drop policy if exists "Super admins can manage checkout settings" on public.checkout_settings;
...
drop policy if exists "Staff can insert email events" on public.email_events;
...
drop policy if exists "Vendor or above can delete product images" on storage.objects;
...
drop policy if exists "Public can read category images bucket" on storage.objects;
...
drop policy if exists "Staff can upload category images" on storage.objects;
...
drop policy if exists "Staff can update category images" on storage.objects;
...
drop policy if exists "Vendor or above can delete category images" on storage.objects;
...
drop policy if exists "Super admins can read vendor identity document files" on storage.objects;
